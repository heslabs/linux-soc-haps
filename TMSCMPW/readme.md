...
* The program offers the industry’s most successful fin field-effect transistor (FinFET) technologies with multi-project wafer (MPW) services and design collateral, for TSMC’s 16-nanometer (16nm) and 7-nanometer (7nm) processes, covering both logic designs and radio frequency (RF) designs.
* Working with service partners in Asia, Europe, Japan, and the United States, TSMC is also providing design collateral for teaching purposes, as well as for research projects leading to silicon test chips. The design collateral for teaching includes tutorial design cases and training materials.
